...
<body
    style="max-width: 800px; margin: auto; margin-top: 3rem; font-family: Arial, sans-serif; font-size: 14px; line-height: 1.5;">
    <style>
        .header {
            display: flex;
            justify-content: space-between;
    ...
    <div class="header">
        ...
        <div class="barcode">
            <img src="https://barcode.tec-it.com/barcode.ashx?data={{ $order->id }}&code=Code128&dpi=96"
                alt="barcode">
