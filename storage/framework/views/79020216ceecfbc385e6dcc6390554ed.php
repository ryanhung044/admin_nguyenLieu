...
unset($__errorArgs, $__bag); ?>" id="full_name"
                        name="full_name" value="<?php echo e(old('full_name', $user->full_name)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="birthday"
                        name="birthday" value="<?php echo e(old('birthday', $user->birthday)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="balance"
                        name="balance" value="<?php echo e(old('balance', $user->balance)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if($user->avatar): ?>
                        ...
                        <?php if(Str::startsWith($user->avatar, ['http://', 'https://'])): ?>
                            <img src="<?php echo e($user->avatar); ?>" alt="Avatar" width="100" class="img-thumbnail">
                        <?php else: ?>
                            <img src="<?php echo e(asset('storage/' . $user->avatar)); ?>" alt="Avatar" width="100" class="img-thumbnail">
                        <?php endif; ?>
                        </div>
                    <?php endif; ?>
                </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hace51f943/domains/giaviet.store/resources/views/admin/user/edit.blade.php ENDPATH**/ ?>