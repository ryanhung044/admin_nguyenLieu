...
unset($__errorArgs, $__bag); ?>" id="commission_rate"
                        name="commission_rate" value="<?php echo e(old('commission_rate', $product->commission_rate)); ?>">
        ...
        <table class="table table-bordered mt-3" id="variants-table">
            ...
            <tbody>
                <?php $__currentLoopData = $variantData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(!empty($variant['attributes']) && isset($variant['price']) && isset($variant['stock'])): ?>
                        <tr>
                            <td>
                                <input type="hidden" name="variants[][attributes]" value='<?php echo json_encode($variant['attributes'], 15, 512) ?>'>
                                <?php echo e(implode(', ', array_map(fn($k, $v) => "$k: $v", array_keys($variant['attributes']), $variant['attributes']))); ?>

                            </td>
                            
                            <td><input type="number" name="variants[][price]" value="<?php echo e($variant['price']); ?>"
                                    class="form-control"></td>
                            <td><input type="number" name="variants[][sale_price]" value="<?php echo e($variant['sale_price']); ?>"
                                    class="form-control"></td>
                            <td><input type="number" name="variants[][stock]" value="<?php echo e($variant['stock']); ?>"
                                    class="form-control"></td>
                            <td>
                                <input type="file" name="variants[][image]" class="form-control">
                                <?php if(!empty($variant['image_url'])): ?>
                                    <img src="<?php echo e(asset($variant['image_url'])); ?>" width="60">
                                <?php endif; ?>
                            </td>
                        </tr>
                    <?php endif; ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hace51f943/domains/giaviet.store/resources/views/admin/products/edit.blade.php ENDPATH**/ ?>